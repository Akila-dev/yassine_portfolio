			...
			<div className="work__wrapper wrapper--large">
				...
				<ul className="work__list">
					{first && <li
						...
						className="work__list-el work__list-el--is-active">
							...
							<div className="work__content">
								<div className="work__content-blurb blurb blurb--framed">
									...
									<p className="blurb__copy">
										This cutting-edge robotic arm is powered by a CAN Bus network,
										that ensures reliability and effectiveness.
									</p>
								</div>
				...
				<ul className="work__navigation">
					<li onClick={onFirstChange} className={isActive && firstIsactive ? "work__navigation-el--is-active" : "work__navigation-el "}></li>
					<li onClick={onSecondChange} className={isActive && secondIsactive ? "work__navigation-el--is-active" : "work__navigation-el "}></li>
					<li onClick={onThirdChange} className={isActive && ThirdIsactive ? "work__navigation-el--is-active" : "work__navigation-el "}></li>
